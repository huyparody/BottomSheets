...
public struct CustomRoundedRectangle_Previews: PreviewProvider {
    public static var previews: some View {
        VStack {
            CustomRoundedRectangle(topLeft: 0, topRight: 16, bottomLeft: 16, bottomRight: 16)
                .stroke(.gray, lineWidth: 1)
                .frame(width: 100, height: 50)

            CustomRoundedRectangle(topLeft: 0, topRight: 0, bottomLeft: 16, bottomRight: 16)
                .stroke(.gray, lineWidth: 1)
                .frame(width: 100, height: 50)

            CustomRoundedRectangle(topLeft: 0, topRight: 0, bottomLeft: 0, bottomRight: 16)
                .stroke(.gray, lineWidth: 1)
                .frame(width: 100, height: 50)
            ...
            CustomRoundedRectangle(topLeft: 16, topRight: 0, bottomLeft: 0, bottomRight: 16)
                .stroke(.gray, lineWidth: 1)
                .frame(width: 100, height: 50)
        }
    }
